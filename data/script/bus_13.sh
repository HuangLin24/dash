...
timeout 1800 ./waf --run 'src/dash/examples/dash-example --traceName=norway_bus_13 --randomSeed=3 --users=5 --linkRate=5Mbps --protocol="ns3::BbClient"' &
timeout 1800 ./waf --run 'src/dash/examples/dash-example --traceName=norway_bus_13 --randomSeed=3 --users=5 --linkRate=5Mbps --protocol="ns3::MpcClient"' &
timeout 1800 ./waf --run 'src/dash/examples/dash-example --traceName=norway_bus_13 --randomSeed=3 --users=5 --linkRate=5Mbps --protocol="ns3::MpcfastClient"' &
timeout 1800 ./waf --run 'src/dash/examples/dash-example --traceName=norway_bus_13 --randomSeed=3 --users=5 --linkRate=5Mbps --protocol="ns3::PensieveClient"' &
sleep 23s
...
rm ~/tarballs/ns-allinone-3.29/ns-3.29/src/dash/model/algorithms/data/*
timeout 1800 ./waf --run 'src/dash/examples/dash-example --traceName=norway_bus_13 --randomSeed=3 --users=5 --linkRate=5Mbps --intervalStep=5 --protocol="ns3::BbClient"' &
timeout 1800 ./waf --run 'src/dash/examples/dash-example --traceName=norway_bus_13 --randomSeed=3 --users=5 --linkRate=5Mbps --intervalStep=5 --protocol="ns3::MpcClient"' &
timeout 1800 ./waf --run 'src/dash/examples/dash-example --traceName=norway_bus_13 --randomSeed=3 --users=5 --linkRate=5Mbps --intervalStep=5 --protocol="ns3::MpcfastClient"' &
timeout 1800 ./waf --run 'src/dash/examples/dash-example --traceName=norway_bus_13 --randomSeed=3 --users=5 --linkRate=5Mbps --intervalStep=5 --protocol="ns3::PensieveClient"' &
sleep 60s
{ cd src/dash/model/algorithms; timeout 1800  python2.7 rl_no_training_mul.py 5 bus_13 72;  }&
wait
